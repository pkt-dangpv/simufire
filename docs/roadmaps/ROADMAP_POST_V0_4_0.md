...
Tareas candidatas:
- Actualizar `docs/planning/PLAN_TRABAJO.md` para eliminar conteos históricos stale (`373/373`, `372/372`, `376/376` en secciones de historial).
- Actualizar `docs/validation/GAPS_INVENTORY.md` para eliminar el mismo tipo de conteos stale en el bloque de historial.
...
Ver roadmap detallado: `docs/roadmaps/ROADMAP_TECHNICAL_SIMULATOR_V0_5.md`
...
|---|---|---|
| Resumen de validación (para terceros) | `docs/validation/SIMUFIRE_VALIDATION_SUMMARY_2026-05-31.md` | ~10 KB |
| Auditoría de preparación para publicación | `docs/audits/PUBLICATION_READINESS_AUDIT_2026-05-31.md` | ~14 KB |
| Calibración HCN/FED detallada | `docs/audits/AUDITORIA_CALIBRACION_FED_HCN_2026-05-27.md` | ~8 KB |
| Inventario de gaps | `docs/validation/GAPS_INVENTORY.md` | ~44 KB |
