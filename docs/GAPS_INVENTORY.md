...
**Generado**: 24 mayo 2026 | **Actualizado**: 28 mayo 2026 (cierre cfast_2r_r0_t450 + rmse_temp)
**Estado validación**: 293/293 PASS required, 60 gaps non-gating
...
**Total: 60 gaps non-gating (per reference_checks.json).**
