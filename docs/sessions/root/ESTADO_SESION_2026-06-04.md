...
- `docs/roadmaps/ROADMAP_TECHNICAL_SIMULATOR_V0_5.md` actualizado: v0.7.0 marcado como COMPLETO (2026-06-04, commit `e441212`), todas las tareas B-01..B-05 + E-07 + GOD-08 marcadas con su commit hash.
...
- `docs/roadmaps/ROADMAP_TECHNICAL_SIMULATOR_V0_5.md` — cierre v0.7.0
