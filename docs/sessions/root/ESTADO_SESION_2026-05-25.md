...
`docs/architecture/PHASE_2E_CO2_DESIGN.md` sección 12.8 añadida.
...
| `docs/architecture/PHASE_2E_CO2_DESIGN.md` | Sección 12.9 — diseño Sub-D, decisión Exp 1C |
...
| `docs/architecture/PHASE_2E_CO2_DESIGN.md` | Docs | Sub-B diagnosis + Sub-D diseño |
