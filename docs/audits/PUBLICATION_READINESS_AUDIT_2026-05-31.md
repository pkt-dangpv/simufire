...
| `docs/validation/GAPS_INVENTORY.md` | Phase 4B row → "calibración aceptable"; header actualizado a 379/379 |
| `docs/planning/PLAN_TRABAJO.md` | Histórico de planificación (contenido muy obsoleto, no bloquea) |
| `scripts/simulation/validate_reference_cases.py` | Reajustes de tolerancias (Phase 2C+) |

Ficheros no trackeados (no bloquean):
- `docs/audits/AUDITORIA_CALIBRACION_FED_HCN_2026-05-27.md` — calibración FED/HCN documentada
- `docs/planning/FINAL_VALIDATION_AND_PUBLICATION_PLAN.md` — plan de publicación actualizado
...
Calibración completa documentada en `docs/audits/AUDITORIA_CALIBRACION_FED_HCN_2026-05-27.md`.
...
| Documento | Contenido |
|---|---|
| `docs/audits/AUDITORIA_CALIBRACION_FED_HCN_2026-05-27.md` | Análisis detallado ratios FED, comparación Purser, limitaciones HCN yield |
| `docs/validation/GAPS_INVENTORY.md` | Inventario de todos los gaps conocidos (4 non-gating, 0 bloqueantes) |
| `docs/planning/FINAL_VALIDATION_AND_PUBLICATION_PLAN.md` | Plan original con estado actualizado a COMPLETADO |
