...
| F7 | `Docu Simufire/` con espacio en nombre — renombrar a `docs/literature/` o `bibliography/` | — | 10 min |
...
│   ├── literature/ (renombrado de Docu Simufire)
