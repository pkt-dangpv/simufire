...
Esta nota resume como aprovechar la biblioteca tecnica reunida en `docs/literature` para llevar `Simufire` desde una validacion interna hacia una validacion empirica basada en estudios publicados y ensayos a escala real.
