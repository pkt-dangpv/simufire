...
func build_state(context: Dictionary) -> Dictionary:
	var state: Dictionary = {
		...
		"phase3_canonical_interzone_heat_shadow_enabled": bool(
			context.get("phase3_canonical_interzone_heat_shadow_enabled", false)
		),
		...
		"phase3_canonical_fire_products_routing_shadow_enabled": bool(
			context.get(
		...
		"phase3_canonical_post_opening_coupling_shadow_enabled": bool(
			context.get("phase3_canonical_post_opening_coupling_shadow_enabled", false)
		),
		"phase3_canonical_interior_opening_shadow_enabled": bool(
			context.get("phase3_canonical_interior_opening_shadow_enabled", false)
		),
		...
		"phase3_canonical_fixed_gross_pressure_network_shadow_enabled": bool(
			context.get(
				"phase3_canonical_fixed_gross_pressure_network_shadow_enabled", false
			)
		),
		...
		"phase3_mass_residence_diagnostics_enabled": bool(
			context.get("phase3_mass_residence_diagnostics_enabled", false)
		),
		...
		"phase3_conservative_lower_return_enabled": bool(context.get("phase3_conservative_lower_return_enabled", false)),
	...
	for room_id in _collect_sorted_room_ids(building):
		...
		state[str(room_id)] = {
			...
			"co_net_transport_kg_step": room.co_net_transport_kg_step,
