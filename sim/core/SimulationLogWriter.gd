...
var phase3_canonical_fuel_object_sync_shadow_enabled: bool = false
...
func configure_phase3_runtime_ownership_ledger(is_enabled: bool) -> void:
	phase3_runtime_ownership_ledger_enabled = is_enabled
...
func configure_phase3_canonical_fuel_object_sync_shadow(is_enabled: bool) -> void:
	phase3_canonical_fuel_object_sync_shadow_enabled = is_enabled
...
func _phase3_runtime_ownership_fields() -> Array[String]:
	...
	for stage_name in [
		...
		for quantity in ["upper_mass_kg", "lower_mass_kg", "upper_energy_kj", "lower_energy_kj"]:
			fields.append("%s_%s_delta_step" % [stage_name, quantity])
	fields.append_array([
		"runtime_owner_observed_mass_delta_kg_step",
		"runtime_owner_observed_energy_delta_kj_step",
		"runtime_owner_mass_residual_kg_step",
		"runtime_owner_energy_residual_kj_step",
		"runtime_owner_projection_call_count",
		"runtime_owner_projection_mass_delta_kg_step",
		"runtime_owner_projection_energy_delta_kj_step",
		"runtime_owner_boundary_energy_delta_kj_step",
		"runtime_owner_projection_boundary_energy_residual_kj_step",
		"runtime_owner_canonical_doorway_upper_mass_delta_kg_step",
		"runtime_owner_canonical_doorway_upper_energy_delta_kj_step",
		"runtime_owner_canonical_doorway_lower_mass_delta_kg_step",
		"runtime_owner_canonical_doorway_lower_energy_delta_kj_step",
		"runtime_owner_doorway_thermal_counterflow_mass_delta_kg_step",
		"runtime_owner_doorway_thermal_counterflow_energy_delta_kj_step",
		"runtime_owner_parcel_pre_gas_kg",
		"runtime_owner_parcel_post_gas_kg",
		"runtime_owner_parcel_pre_energy_kj",
		"runtime_owner_parcel_post_energy_kj",
		"runtime_owner_parcel_created_gas_kg",
		"runtime_owner_parcel_delivered_gas_kg",
		"runtime_owner_parcel_cancelled_gas_kg",
		"runtime_owner_parcel_created_energy_kj",
		"runtime_owner_parcel_delivered_energy_kj",
		"runtime_owner_parcel_cancelled_energy_kj",
		"runtime_owner_parcel_mass_residual_kg",
		"runtime_owner_parcel_energy_residual_kj",
		"runtime_owner_parcel_event_count",
	])
	return fields
...
func _phase3_fixed_gross_pressure_skew_fields() -> Array[String]:
	return [
		...
		"phase3_shadow_fixed_gross_pressure_accepted_net_out_kg_total",
		"phase3_shadow_fixed_gross_cap_positive_count_total",
		"phase3_shadow_fixed_gross_cap_negative_count_total",
		"phase3_shadow_fixed_gross_cap_requested_positive_kg_total",
		"phase3_shadow_fixed_gross_cap_accepted_positive_kg_total",
		"phase3_shadow_fixed_gross_cap_requested_negative_abs_kg_total",
		"phase3_shadow_fixed_gross_cap_accepted_negative_abs_kg_total",
		"phase3_shadow_fixed_gross_cap_rejected_abs_kg_total",
		"phase3_shadow_fixed_gross_cap_max_rejected_abs_kg",
...
func _phase3_coupled_solver_fields() -> Array[String]:
	return [
		...
		"phase3_shadow_coupled_solver_cycle_guard_attempt_total",
		"phase3_shadow_coupled_solver_cycle_guard_accept_total",
		"phase3_shadow_coupled_solver_cycle_guard_last_rho",
		"phase3_shadow_coupled_solver_cycle_guard_last_cosine",
		"phase3_shadow_coupled_solver_cycle_detect_total",
		...
		"phase3_shadow_coupled_solver_adaptive_jacobian_attempt_total",
		"phase3_shadow_coupled_solver_adaptive_jacobian_accept_total",
		"phase3_shadow_coupled_solver_adaptive_jacobian_columns_forward_total",
		"phase3_shadow_coupled_solver_adaptive_jacobian_columns_backward_total",
		"phase3_shadow_coupled_solver_adaptive_jacobian_columns_reduced_total",
		"phase3_shadow_coupled_solver_adaptive_jacobian_branch_crossing_avoided_total",
		"phase3_shadow_coupled_solver_adaptive_jacobian_derivative_consistency_fail_total",
		"phase3_shadow_coupled_solver_adaptive_jacobian_min_effective_step_pa",
...
func _build_csv_header() -> String:
	...
	if phase3_canonical_fuel_object_sync_shadow_enabled:
		header += "," + ",".join(PackedStringArray(
			_phase3_fuel_object_sync_fields()
		))
...
func _phase3_multisurface_correspondence_fields() -> Array[String]:
	var fields: Array[String] = [
		"phase3_shadow_multisurface_cumulative_step_count",
	...
	for surface_name in ["ceiling", "upper_wall", "lower_wall", "floor"]:
		var prefix: String = "phase3_shadow_multisurface_" + surface_name
		for suffix in [
			"_area_m2",
			"_energy_kj",
			"_temp_inner_c",
			"_temp_middle_c",
			"_temp_outer_c",
			"_cumulative_gas_exchange_kj",
			"_cumulative_fire_radiation_kj",
			"_cumulative_exterior_removed_kj",
		]:
			fields.append(prefix + suffix)
	return fields


func _phase3_combustion_correspondence_fields() -> Array[String]:
	return [
...
func _phase3_fire_products_fields() -> Array[String]:
	var fields: Array[String] = [
		"phase3_shadow_fire_products_active_flag",
		"phase3_shadow_fire_products_supported_flag",
		"phase3_shadow_fire_products_object_sync_required_flag",
		"phase3_shadow_fire_products_profile_object_count",
		"phase3_shadow_fire_products_quality_phi",
		"phase3_shadow_fire_products_carbon_scale",
		"phase3_shadow_fire_products_common_fraction",
		"phase3_shadow_fire_products_requested_fuel_MJ",
		"phase3_shadow_fire_products_accepted_fuel_MJ",
		"phase3_shadow_fire_products_requested_o2_kg",
		"phase3_shadow_fire_products_accepted_o2_kg",
		"phase3_shadow_fire_products_requested_total_energy_kj",
		"phase3_shadow_fire_products_accepted_total_energy_kj",
		"phase3_shadow_fire_products_effective_chi_rad",
		"phase3_shadow_fire_products_requested_radiative_energy_kj",
		"phase3_shadow_fire_products_accepted_radiative_energy_kj",
		"phase3_shadow_fire_products_requested_convective_energy_kj",
		"phase3_shadow_fire_products_accepted_convective_energy_kj",
		"phase3_shadow_fire_products_accepted_plume_driver_hrr_kw",
	...
	fields.append_array([
		"phase3_shadow_fire_products_requested_carbon_available_kg",
		"phase3_shadow_fire_products_requested_carbon_products_kg",
		"phase3_shadow_fire_products_requested_carbon_untracked_kg",
		"phase3_shadow_fire_products_requested_carbon_residual_kg",
		"phase3_shadow_fire_products_accepted_carbon_available_kg",
		"phase3_shadow_fire_products_accepted_carbon_products_kg",
		"phase3_shadow_fire_products_accepted_carbon_untracked_kg",
		"phase3_shadow_fire_products_accepted_carbon_residual_kg",
		"phase3_shadow_fire_products_fuel_residual_MJ",
		"phase3_shadow_fire_products_o2_residual_kg",
		"phase3_shadow_fire_products_energy_residual_kj",
...
func _phase3_fuel_object_sync_fields() -> Array[String]:
	var fields: Array[String] = []
	for field_name in [
		"active_flag", "supported_flag", "rejection_mask", "object_count",
		"identity_signature", "eligible_count", "pre_fuel_MJ",
		"proposed_fuel_MJ",
		"committed_fuel_MJ", "requested_debit_MJ", "allocated_debit_MJ",
		"committed_debit_MJ", "allocation_residual_MJ",
		"atomic_residual_MJ", "aggregate_residual_MJ", "exhausted_count",
		"minimum_remaining_MJ", "live_fuel_MJ", "live_delta_MJ",
		"seed_residual_MJ"
	]:
		fields.append("phase3_shadow_fuel_object_sync_" + field_name)
	return fields
	...
	for room_id in _collect_room_ids(state):
		...
		if phase3_canonical_zone_shadow_enabled:
			for field_name in [
				...
				"phase3_shadow_multisurface_migration_energy_kj",
				"phase3_shadow_multisurface_migration_residual_kj",
				"phase3_shadow_multisurface_energy_pre_kj",
				"phase3_shadow_multisurface_energy_post_kj",
				"phase3_shadow_multisurface_radiation_residual_kj",
				"phase3_shadow_multisurface_upper_exchange_kj",
				"phase3_shadow_multisurface_lower_exchange_kj",
				"phase3_shadow_multisurface_exterior_removed_kj",
				"phase3_shadow_multisurface_combined_energy_residual_kj",
				"phase3_shadow_multisurface_boundary_metadata_complete_flag",
				"phase3_shadow_multisurface_adiabatic_surface_count",
		...
		if phase3_canonical_fire_products_routing_shadow_enabled:
			for field_name in _phase3_fire_products_routing_fields():
				fields.append("%.8f" % float(rs.get(field_name, 0.0)))
		if phase3_canonical_fuel_object_sync_shadow_enabled:
			for field_name in _phase3_fuel_object_sync_fields():
				fields.append("%.8f" % float(rs.get(field_name, 0.0)))
		if phase3_canonical_pressure_relaxation_shadow_enabled:
			for field_name in [
		...
		if phase3_canonical_interior_pressure_shadow_enabled:
			for field_name in [
				"phase3_shadow_interior_pressure_enabled_flag",
				"phase3_shadow_interior_pressure_opening_count",
				"phase3_shadow_interior_pressure_pre_pa",
				"phase3_shadow_interior_pressure_raw_out_gas_kg_step",
				"phase3_shadow_interior_pressure_raw_in_gas_kg_step",
				"phase3_shadow_interior_pressure_requested_out_gas_kg_step",
				"phase3_shadow_interior_pressure_requested_in_gas_kg_step",
				"phase3_shadow_interior_pressure_accepted_out_gas_kg_step",
				"phase3_shadow_interior_pressure_accepted_in_gas_kg_step",
				"phase3_shadow_interior_pressure_net_mass_kg_step",
				"phase3_shadow_interior_pressure_equilibrium_fraction",
				"phase3_shadow_interior_pressure_full_delta_pa",
				"phase3_shadow_interior_pressure_limited_delta_pa",
				"phase3_shadow_interior_pressure_predicted_post_pa",
				"phase3_shadow_interior_pressure_crossing_prevented_count",
				"phase3_shadow_interior_pressure_mass_residual_kg",
