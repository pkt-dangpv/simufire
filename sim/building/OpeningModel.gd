...
# que ver con `thermal_gap_fraction`, que es la heurística térmica heredada y
# queda expresamente fuera de la deformación prescrita de D2.
var leakage_class: String = "none"
var leakage_area_override_m2: float = -1.0
# F2.2D2: historias prescritas de ELA adicional por deformacion. Son datos
# runtime deliberadamente separados de `thermal_gap_fraction`: no convierten
