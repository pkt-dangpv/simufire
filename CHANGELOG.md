...
- **Conclusión de activación controlada**: activar M4 en casos existentes requiere una pasada coordinada de corrección ILV que actualice/elimine los `threshold_metrics` afectados. Los únicos candidatos seguros son **nuevos casos** diseñados desde cero con M4 como comportamiento correcto esperado (como `fp_ilv_upper_throttle_on.json`).
