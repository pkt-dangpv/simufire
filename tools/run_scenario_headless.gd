...
func _run() -> void:
	...
	if bool(_cli_args.get("phase3_residual_projection_shadow", false)):
		engine.phase3_residual_projection_shadow_enabled = true
	if bool(_cli_args.get("phase3_zone_transition_diagnostics", false)):
	...
	if bool(_cli_args.get("phase3_co2_zonal_transport_consistency", false)):
		engine.phase3_co2_zonal_transport_consistency_enabled = true
	...
	if bool(_cli_args.get("phase3_coupled_interior_bundle_shadow", false)):
		engine.phase3_canonical_zone_shadow_enabled = true
		engine.phase3_canonical_persistence_shadow_enabled = true
		engine.phase3_canonical_interior_opening_shadow_enabled = true
		engine.phase3_coupled_pressure_solver_shadow_enabled = true
		engine.phase3_coupled_interior_bundle_shadow_enabled = true
...
func _parse_args(args: Array[String]) -> Dictionary:
	...
	while index < args.size():
		...
		elif arg == "--phase3-residual-projection-shadow":
			parsed["phase3_residual_projection_shadow"] = true
		elif arg == "--phase3-zone-transition-diagnostics":
			parsed["phase3_zone_transition_diagnostics"] = true
		...
		elif arg == "--phase3-co2-zonal-transport-consistency":
			parsed["phase3_co2_zonal_transport_consistency"] = true
		...
		elif arg == "--phase3-coupled-interior-bundle-shadow":
			parsed["phase3_coupled_interior_bundle_shadow"] = true
